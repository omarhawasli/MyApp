...
import MyApp.Model.AudioManager;
...
public class ShellGameController {
    ...
    public void initialize(){
        ...
        queen = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/images/queen.png")));
        jack = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/images/jack.png")));
        yugi = new Image(Objects.requireNonNull(getClass().getResourceAsStream("/images/yugi1.png")));
